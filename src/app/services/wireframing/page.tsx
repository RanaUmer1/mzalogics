...
export const metadata: Metadata = {
  ...
  description:
    'Fast, collaborative wireframing for web apps and products to clarify flows and structure before visual design.',
};

const WireframingPage = () => {
  return (
    <Fragment>
      <NavbarOne
...
export default WireframingPage;
