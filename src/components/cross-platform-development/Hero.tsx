...
const Hero = () => {
  return (
    <section className="relative pt-36 lg:pt-[150px] md:pt-[180px] pb-12 sm:pb-0" aria-label="Cross-Platform Development">
          ...
          <div className="space-y-4 relative z-20">
            <RevealAnimation delay={0.1}>
              <h1 className="text-center max-w-[800px] mx-auto">
                Expert <span className="text-primary-500">Cross-Platform</span> App Development
              </h1>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <p className="lg:max-w-[818px] md:max-w-[618px] sm:max-w-[518px] max-w-[450px] w-full mx-auto">
                Build powerful, native-quality mobile applications for both iOS and Android from a single codebase with our expert cross-platform development services.
              </p>
            </RevealAnimation>
