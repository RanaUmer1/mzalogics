            ...
            <div className="grid grid-cols-12 justify-center items-stretch gap-y-8 md:gap-x-8">
              ...
              <RevealAnimation delay={0.2}>
                <div className="col-span-12 lg:col-span-8 relative rounded-[20px] overflow-hidden h-full">
                  ...
                  <div className="bg-background-1 dark:bg-background-6 py-8 lg:py-[42px] px-7 lg:px-14 space-y-14 h-full flex flex-col justify-between text-center lg:text-left items-center lg:items-start">
                    <div className="">
                      <span className="badge badge-primary-light mb-5"> Why choose MZA Logics? </span>
                      <h2 className="max-w-[564px]">More Than Developers — We're Your Technology Growth Partner</h2>
                    </div>
                    <div>
                      <LinkButton
                        href="/contact-us"
                ...
                <div className="col-span-12 md:col-span-6 lg:col-span-4 h-full">
                  <div className="bg-background-1 dark:bg-background-6 rounded-[20px] p-8 space-y-6 h-full flex flex-col justify-between">
                    <div className="space-y-1">
                      <h3 className="text-heading-5">Strategic Technology Partner</h3>
                      <p className="md:max-w-[252px]">We don't just write code—we solve real business problems aligned with your growth goals.</p>
                    </div>
              ...
              <RevealAnimation delay={0.5}>
                <div className="col-span-12 md:col-span-6 lg:col-span-4 h-full">
                  <div className="bg-white dark:bg-background-6 rounded-[20px] p-8 space-y-6 h-full flex flex-col justify-between">
                    <div className="space-y-1">
                      <h3 className="text-heading-5">25+ Skilled Professionals</h3>
                      <p className="md:max-w-[252px]">Senior engineers with expertise across modern tech stacks and proven delivery.</p>
                    </div>
              ...
              <RevealAnimation delay={0.7}>
                <div className="col-span-12 md:col-span-6 lg:col-span-4 h-full">
                  <div className="bg-white dark:bg-background-6 rounded-[20px] p-8 space-y-6 h-full flex flex-col justify-between">
                    <div className="space-y-1">
                      <h3 className="text-heading-5">Secure & Scalable Solutions</h3>
                      <p className="md:max-w-[252px]">Enterprise-grade architecture built for performance, security, and future growth.</p>
                    </div>
              ...
              <RevealAnimation delay={0.9}>
                <div className="col-span-12 md:col-span-6 lg:col-span-4 h-full">
                  <div className="bg-white dark:bg-background-6 rounded-[20px] p-8 space-y-6 h-full flex flex-col justify-between">
                    <div className="space-y-1">
                      <h3 className="text-heading-5">Transparent & Reliable</h3>
                      <p className="md:max-w-[252px]">Clear communication, honest timelines, and on-time delivery you can count on.</p>
                    </div>
                    <div className="flex-1 flex items-center">
