      ...
      <div className="main-container">
        <div className="text-center space-y-3 mb-10 md:mb-[70px]">
          <RevealAnimation delay={0.2}>
            <h2>Design systems &amp; UI foundations</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <p className="max-w-[776px] mx-auto">
              I help teams define tokens, components, and documentation so designers and engineers can ship quickly
          ...
          <div className="grid grid-cols-12 sm:gap-8 gap-y-8">
              ...
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Design tokens</h3>
                    <p>Color, typography, spacing, and elevation tokens mapped to your brand and platforms.</p>
                  </div>
                  <div>
            ...
            <RevealAnimation delay={0.5}>
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Component libraries</h3>
                    <p>Reusable UI components in Figma (and optionally code) with clear usage guidelines.</p>
                  </div>
                  <div>
            ...
            <RevealAnimation delay={0.6}>
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Patterns &amp; templates</h3>
                    <p>Common layouts and flows (auth, tables, settings, modals) ready to reuse across products.</p>
                  </div>
                  <div>
                    <figure className="sm:max-w-[345px] max-w-full w-full">
            ...
            <RevealAnimation delay={0.7}>
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Design system audits</h3>
                    <p>Review your existing product UI and recommend a roadmap toward a maintainable system.</p>
                  </div>
                  <div>
            ...
            <RevealAnimation delay={0.8}>
              <div className="col-span-12 lg:col-span-8">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Enablement &amp; documentation</h3>
                    <p>
                      Playbooks, examples, and workshops so designers and developers actually adopt the system in their
                      day-to-day work.
                    </p>
                  </div>
                  <div>
