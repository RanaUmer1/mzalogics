      ...
      <div className="main-container">
        <div className="space-y-8">
          <CTAV3
            ...
            ctaHeading=" Launch your next CMS with MzaLogics"
            ctaHeadingClass="text-secondary dark:text-accent max-w-[1042px] mx-auto"
            description="Plan, design, and build a CMS that gives your team a smooth editing experience and your users fast, reliable content."
            ...
            ctaBtnText="Talk to our CMS team"
          />
