        ...
        <div className="space-y-14 text-center">
          <div className="space-y-4">
            <RevealAnimation delay={0.2}>
              <h1 className="mx-auto max-w-[886px] w-full">Social campaigns that look good and drive results.</h1>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[700px] w-full">
                We plan, design, and optimize social media content across platforms so your brand shows up consistently and
                turns attention into clicks, signups, or sales.
              </p>
            </RevealAnimation>
          </div>
