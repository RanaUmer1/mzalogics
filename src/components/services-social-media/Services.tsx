      ...
      <div className="main-container">
        <div className="text-center space-y-3 mb-10 md:mb-[70px]">
          <RevealAnimation delay={0.2}>
            <h2>Social media services for modern brands</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <p className="max-w-[776px] mx-auto">
              From strategy and content calendars to assets, publishing, and reportingwe help you show up where your
          ...
          <div className="grid grid-cols-12 sm:gap-8 gap-y-8">
              ...
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Social strategy &amp; positioning</h3>
                    <p>Channel selection, messaging, and posting cadence aligned to your goals.</p>
                  </div>
                  <div>
            ...
            <RevealAnimation delay={0.5}>
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Content creation &amp; design</h3>
                    <p>Post concepts, copy, and visuals tailored to each platform and audience.</p>
                  </div>
                  <div>
            ...
            <RevealAnimation delay={0.6}>
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Publishing &amp; community</h3>
                    <p>Scheduling, moderation, and engagement workflows that fit your team.</p>
                  </div>
                  <div>
                    <figure className="sm:max-w-[345px] max-w-full w-full">
            ...
            <RevealAnimation delay={0.7}>
              <div className="col-span-12 lg:col-span-4 sm:col-span-6">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Paid social campaigns</h3>
                    <p>Creative, targeting, and optimization for performance-focused campaigns.</p>
                  </div>
                  <div>
            ...
            <RevealAnimation delay={0.8}>
              <div className="col-span-12 lg:col-span-8">
                <div className="bg-white dark:bg-background-8 rounded-[20px] md:p-8 p-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="text-heading-6 md:text-heading-5">Reporting &amp; iteration</h3>
                    <p>
                      Dashboards and reviews that focus on the metrics that matterso we can double down on what works
