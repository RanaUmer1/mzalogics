...
const listItems = [
  ...
  { id: '2', text: 'Works with your existing CMS and stack' },
];
      ...
      <div className="main-container">
        <div className="space-y-8">
          <CTAV3
            ...
            ctaHeading=" Let&apos;s build an SEO roadmap your team can actually execute"
            ctaHeadingClass="text-secondary dark:text-accent max-w-[1042px] mx-auto"
            description="Tell us about your product, audience, and current trafficwe&apos;ll come back with a clear plan and quick wins."
            ...
            ctaBtnText="Request a free SEO review"
          />
