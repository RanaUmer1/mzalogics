        ...
        <div className="relative z-20">
          <div className="text-center space-y-4 mb-14">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-green">PPC &amp; Paid Media</span>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <h1 className="md:max-w-[804px] sm:max-w-[600px] max-w-[400px] mx-auto">
                <span className="hero-text-gradient hero-text-color-1 block">
                  Campaigns built to scale, not just spend.
                </span>
              </h1>
            </RevealAnimation>
            ...
            <RevealAnimation delay={0.3}>
              <p className="md:max-w-full sm:max-w-[560px] max-w-[390px] mx-auto">
                We plan, launch, and optimize PPC campaigns across channels to bring in qualified traffic and measurable
            ...
            <div className="flex items-center justify-center sm:gap-4 gap-y-4 sm:flex-row flex-col">
              ...
              <RevealAnimation delay={0.9} direction="right" offset={50}>
                <div className="text-center sm:text-left">
                  <p className="text-tagline-2 font-medium text-secondary dark:text-accent">Accounts we&apos;ve optimized</p>
                  <p className="text-tagline-3">From early-stage startups to established brands.</p>
                </div>
              </RevealAnimation>
            </div>
          </div>
        ...
        <div className="mt-14 relative z-30">
          ...
          <RevealAnimation delay={1}>
            <figure className="max-w-[1251px] mx-auto w-full">
              <Image
                src={heroImage}
                alt="PPC performance dashboard"
                className="size-full object-cover dark:hidden"
                priority
              />
              <Image
                src={heroImageDark}
                alt="PPC performance dashboard dark mode"
