...
const servicesV2: ServiceV2[] = [
  {
    ...
    description: 'Documented test cases for critical flows, executed by experienced QA engineers.',
    image: {
      light: service1,
      dark: service1Dark,
      alt: 'Test case management UI',
    },
    layout: 'large',
  ...
  },
  {
    id: 2,
    title: 'UAT support',
    description: 'Partner with your business stakeholders to plan and run effective UAT cycles.',
    image: {
      light: service2,
      dark: service2Dark,
      alt: 'UAT planning interface',
    },
    layout: 'medium',
  },
  {
    id: 3,
    title: 'Smoke & sanity suites',
    description: 'Lightweight suites focused on the most important user journeys for every build.',
    image: {
      light: service3,
      dark: service3Dark,
  ...
  },
  {
    ...
    description: 'Pre-release checks that combine test results with risk assessment and clear go/no-go input.',
    image: {
      light: service4,
      dark: service4Dark,
      alt: 'Release checklist UI',
    },
    layout: 'large',
  },
  {
    ...
    description: 'Repro steps, severity, environment details, and visual evidence that make issues easy to fix.',
    image: {
      light: service5,
      dark: service5Dark,
      alt: 'Bug tracking overview',
    },
    layout: 'full',
  },
];
      ...
      <div className="main-container">
        ...
        <div className="text-center space-y-3 mb-[70px]">
          <RevealAnimation delay={0.1}>
            <h2>Manual testing services built for real teams</h2>
          </RevealAnimation>

          <RevealAnimation delay={0.2}>
            <p>Everything you need to confidently ship features without surprising your users.</p>
          </RevealAnimation>
        </div>
        {/* Services Grid */}
